...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1b5f4afb2dfab5b50ba603ef5575e15a) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("mirage", None);
                           FindlibPackage ("cohttp.mirage", None);
                           FindlibPackage ("pcap", None);
                           FindlibPackage ("pcap.mirage", None);
                           FindlibPackage ("uri", None);
                           FindlibPackage ("re", None);
                           FindlibPackage ("cow", None)
                        ];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\132<st\180q\000<\135\157c\139\249M\171\150";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
